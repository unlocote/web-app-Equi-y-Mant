<?php
	...
	$sql = "SELECT * FROM tbl_fecha $where LIMIT 1";
...
<html lang="es">
	...
	<body>
		...
		<div class="container">
			<div class="row">
				<h2 style="text-align:center">FECHA PERIODO Beta </h2>
			</div>
			
			<div class="row">
				<a href="curso.php" class="btn btn-primary">REGRESAR</a>
			...
			<div class="row table-responsive">
					...
					<tbody>
						<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
							<tr>
								...
								<td><a href="modificarFecha.php?id=<?php echo $row['id']; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
								<!--
				...
				<br><br><br>
				<a href="curso.php" class="btn btn-primary">REGRESAR</a>
				<a href="updateDatos1.php" class="btn btn-primary">CARGAR CLIENTE</a>
			</div>
		</div>
