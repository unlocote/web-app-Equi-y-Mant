	...
	<body>
		...
		<div class="container">
			...
			<div class="row">
				...
				<!--<a href="importarFecha.php" target="_blank" class="btn btn-primary">CARGAR TBL</a>-->
				<a href="indexTarifa.php" target="_blank" class="btn btn-primary">CARGAR TB_TARIFAS</a>
				<a href="indexFecha.php" target="_blank" class="btn btn-primary">CARGAR TB_FECHA</a>
				<a href="index5.php" target="_blank" class="btn btn-primary">TBL INSTALACION</a>
				<a href="updateCodigosValor.php" target="_blank" class="btn btn-primary">TBL VALOR ACTIVA</a>
					...
					<tbody>
						<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
							<tr>
								...
								<td><a href="modificarReem.php?COD_PROPIO=<?php echo $row['COD_PROPIO']; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
								
								<!--
								<td><img src="barcode-php1/generar.php/?variable=<?php //echo $row['telefono'];?>"/></span></a></td>-->
									
								<td><img src="barcode-php1/generar2.php/?variable=<?php echo $row['COD_BAR'];?>"/></span></a></td>	
								...
								<td><img src="barras/<?php echo $row['COD_BAR'];?>"/></span></a></td>  
								 <!--../../pdf/   barras/-->
