	...
	<body>
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="guardar.php" autocomplete="off">
				...
				<div class="form-group">
					<label for="telefono" class="col-sm-2 control-label">codigobarras</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="codigobarras" name="codigobarras" placeholder="codigobarras">
					</div>
				</div>
